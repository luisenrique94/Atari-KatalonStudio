...
WebUI.click(findTestObject('ReporteGeneral/span_REPORTE GENERAL'))

WebUI.click(findTestObject('ReporteGeneral/Desde'))

WebUI.delay(2)

WebUI.clickOffset(findTestObject('ReporteGeneral/Desde'), 0, 0)

WebUI.sendKeys(findTestObject('ReporteGeneral/Desde'), Keys.chord(Keys.CLEAR))

WebUI.delay(5)

WebUI.sendKeys(findTestObject('ReporteGeneral/Desde'), '01/01/2019')

WebUI.click(findTestObject('ReporteGeneral/Hasta'))
